...
<!-- BEGIN AI-DLC v1.0.1 — generated by scripts/install-aidlc.sh. Do not edit below. -->
<!-- Edit scripts/claude-md-project.md for project context, then re-run the script. -->
