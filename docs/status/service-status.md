...
- **RKE2 etcd Snapshots** workload (`ansible/k8s/etcd_backup.yml`, web UI → Backups & DR):
...
- **MSSQL Scheduled Backups** workload (`ansible/db/mssql_backup.yml`, web UI → Backups & DR):
