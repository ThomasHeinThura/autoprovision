...
[`docs/runbooks/`](../../docs/runbooks/) are kept as the manual/theory reference for each
automated step.
...
- [rke2-cluster/prod-rke2-installation.md](../../docs/runbooks/prod-rke2-installation.md)
- [rke2-cluster/uat-rke2-installation.md](../../docs/runbooks/uat-rke2-installation.md)
- [rke2-cluster/rke2-addons-istio-argocd-headlamp.md](../../docs/runbooks/rke2-addons-istio-argocd-headlamp.md)
- [rke2-cluster/metallb-install.md](../../docs/runbooks/metallb-install.md)
