...
| --------- | ----- | -------- | ------------ |
| `prod_k8s` | Prod RKE2 cluster | `ansible/k8s/rke2_cluster.yml` | 3 servers + 5 agents |
| `uat_k8s`  | UAT RKE2 cluster | `ansible/k8s/rke2_cluster.yml` | 1 server + 2 agents |
...
| `prod_sql` | Prod MSSQL AG | `ansible/db/mssql_ag.yml` | 3 MSSQL VMs |
| `uat_sql`  | UAT MSSQL | `ansible/db/mssql_single.yml` | UAT MSSQL VM |
