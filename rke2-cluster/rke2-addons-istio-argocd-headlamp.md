...
> run [ansible/k8s_addons.yml](../ansible/k8s_addons.yml) and
> [ansible/k8s_wso2.yml](../ansible/k8s_wso2.yml) against the cluster kubeconfig on the
...
**The web UI's WSO2 cards run [ansible/k8s_wso2.yml](../ansible/k8s_wso2.yml)**, which renders
...
- **Production:** the read-scale AG (`CLUSTER_TYPE = NONE`) has **no virtual listener** — point
  ...
  [ansible/mssql_ag.yml](../ansible/mssql_ag.yml) checklist.
- **UAT:** point WSO2 at the single MSSQL instance.

DB notes and the host/route summary: [planning/wso2-rke2.md](../planning/wso2-rke2.md).
